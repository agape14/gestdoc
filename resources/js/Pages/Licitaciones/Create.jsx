        ...
        <MainLayout>
            ...
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-body" style={{ maxWidth: '800px', margin: '0 auto' }}>
                <div className="mb-4 d-flex justify-content-between align-items-center">
                    <div>
                        <h3 className="fw-bold mb-1">Nueva Licitación</h3>
                        <p className="text-secondary small">Registrar una nueva licitación en el sistema.</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            placeholder="Ej. Construcción de Parque Central"
                            value={data.titulo}
                    ...
                    <div className="mb-3">
                        <label className="form-label fw-medium">Estado Inicial</label>
                        <select
                    ...
                    <div className="d-flex justify-content-end mt-5 pt-3 border-top">
                        ...
                        <SubmitButton processing={processing} icon="bi-save" className="px-5">
                            Guardar Licitación
                        </SubmitButton>
                    </div>
                </form>
