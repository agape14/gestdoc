...
export default function Create({ menuOptions = [] }) {
                ...
                <form onSubmit={submit}>
                    ...
                    {showMenuAccess && (
                        <div className="mb-4 p-3 rounded-3 border bg-light bg-opacity-50">
                            ...
                            <p className="text-secondary small mb-3">Selecciona los menús que podrá ver este usuario. Por defecto tiene todos.</p>
