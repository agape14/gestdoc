...
export default function Edit({ especialista }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('especialistas-ejecucion.update', especialista.id), { forceFormData: true });
    };

    return (
        <MainLayout>
            <Head title="Editar Especialista en Ejecución" />
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-body" style={{ maxWidth: '800px', margin: '0 auto' }}>
                <div className="mb-4">
                    <h3 className="fw-bold mb-1">Editar Especialista en Ejecución</h3>
                </div>
