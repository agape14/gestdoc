...
export default function Create({ folderId = null, breadcrumbLabel = '', opcionesTipoUnidad = [] }) {
                ...
                <form onSubmit={submit}>
                    <div className="row g-3 mb-4">
                        <div className="col-md-6">
                            ...
                            <input type="text" className={`form-control ${errors.tipo_inversion ? 'is-invalid' : ''}`} value={data.tipo_inversion} onChange={e => setData('tipo_inversion', e.target.value)} placeholder="Ej. IOARR, ACTIVIDAD" />
                        ...
                        <div className="col-12 mt-3">
                            ...
                            <p className="small text-secondary mb-2">Ingrese los cuatro componentes. El total se calcula como O + P + R + S.</p>
                        </div>
                        <div className="col-md-3">
