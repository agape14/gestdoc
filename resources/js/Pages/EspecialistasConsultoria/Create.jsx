...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('especialistas-consultoria.store'), { forceFormData: true });
    };

    return (
        <MainLayout>
            <Head title="Nuevo Especialista en Consultoría" />
            <div className="card border-0 shadow-sm p-4 rounded-4 bg-body" style={{ maxWidth: '800px', margin: '0 auto' }}>
                <div className="mb-4">
                    <h3 className="fw-bold mb-1">Nuevo Especialista en Consultoría</h3>
                </div>
